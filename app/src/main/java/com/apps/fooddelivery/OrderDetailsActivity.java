...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    TextView textView_unqid, textView_date, textView_address, textView_comment, textView_qty, textView_price, textView_status,textView_time,payBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OrderDetailsActivity.this,CreditCardPaymentActivity.class);
